...
var currentKeyCode="";document.addEventListener("keydown",function(e){"s"===e.key&&(currentKeyCode=e.key)}),document.addEventListener("keyup",function(e){var n=document.querySelector(".grid-container");"x"===e.key&&"s"===currentKeyCode&&n.classList.toggle("active"),currentKeyCode=""});
